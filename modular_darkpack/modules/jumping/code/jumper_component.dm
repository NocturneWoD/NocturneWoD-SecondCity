...
/datum/component/jumper/proc/jump(mob/living/jumper, atom/target)
	...
	jumper.safe_throw_at(adjusted_target, jumper.throw_range, 1, jumper, null, null, null, jumper.move_force, spin = FALSE) // NOCTURNE EDIT - ORIGINAL: jumper.safe_throw_at(adjusted_target, jumper.throw_range, jumper.throw_speed, jumper, null, null, null, jumper.move_force, spin = FALSE)
