/datum/techweb_node/augmentation
	...
	design_ids = list(
		...
		"cybernetic_ears",
		// "cybernetic_ears_cat", // NOCTURNE REMOVAL
		"cybernetic_lungs",
		"cybernetic_stomach",
		"cybernetic_liver",
		"cybernetic_heart",
...
/datum/techweb_node/cyber/cyber_organs
	...
	design_ids = list(
		...
		"cybernetic_ears_u",
		// "cybernetic_ears_u_cat", // NOCTURNE REMOVAL
...
/datum/techweb_node/cyber/cyber_organs_upgraded
	...
	design_ids = list(
		...
		// "cybernetic_ears_whisper_cat", // NOCTURNE REMOVAL
		"cybernetic_ears_volume",
		// "cybernetic_ears_volume_cat", // NOCTURNE REMOVAL
...
/datum/techweb_node/cyber/cyber_organs_adv
	...
	design_ids = list(
		...
		// "cybernetic_ears_xray_cat", // NOCTURNE REMOVAL
		"ci-thermals",
		"ci-xray",
		"ci-thermals-moth",
		"ci-xray-moth",
