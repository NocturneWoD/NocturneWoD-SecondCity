	...
	if(SSticker.current_state == GAME_STATE_STARTUP)
		...
		if(!SSticker || SSticker.current_state <= GAME_STATE_PREGAME)
			...
			dat += {"
				...
				<a class="menu_button" href='byond://?src=[text_ref(src)];view_manifest=1'>Manifest</a>
			"}
		...
		dat += {"
			<br>
			<a class="menu_button" href='byond://?src=[text_ref(src)];character_setup=1'>Setup Character (<span id="character_slot">[client.prefs.read_preference(/datum/preference/name/real_name)]</span>)</a>
